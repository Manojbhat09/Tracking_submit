...
parser.add_argument('--data_dir', type=str, default='/home/jupyter/argoverse-tracking/train', help='specify the datadir for training')
...
def create_dataloader(logger):
    ...
    train_loader = DataLoader(train_set, batch_size=args.batch_size, pin_memory=True,
                              num_workers=1, shuffle=True, collate_fn=train_set.collate_batch,
                              drop_last=True)
...
if __name__ == "__main__":
    ...
    # create dataloader & Neuralnetwork & optimizer

...
import sys
# sys.path.append("/home/kartik/DL_model/PointRCNN_CNN/lib/utils/")

# Internal Modules
from lib.utils.pcnn_util_funcs import UFloatTensor, ULongTensor
from lib.utils.pcnn_util_layers import Conv, SepConv, Dense, EndChannels
...
class PointCNN(nn.Module):
    ...
    def forward(self, x : Tuple[FloatTensor,  # (N, P, dims)
        ...
        pts_idx = self.r_indices_func(rep_pts, pts).cuda()
        # -------------------------------------------------------------------------- #
